...
/** Icona recolorable via CSS mask (usa currentColor) */
      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-10 md:gap-16 items-start">
          ...
          <div className="flex flex-col md:h-full md:justify-between text-left">
            ...
            >
              <span className="block text-white">Sappiamo <br />che ti <span className="text-[var(--brand-accent-1)]">piace</span></span>
              <span className="block text-white">non <span className="text-[var(--brand-accent-2)]">pensarci</span> <span className="text-[var(--brand-primary)]">troppo</span></span>
            </h2>
            ...
            {/* Social (mobile) → 2 righe da 3 icone, più grandi e più in basso */}
            <ul className="md:hidden mt-14 grid grid-cols-3 gap-6 justify-items-center">
              {SOCIAL_LINKS.map((s) => (
                <li key={s.alt}>
                  <a
                    href={s.href}
          ...
          {/* Social (desktop) → colonna, leggermente ingrandite e distanziate */}
          <ul className="hidden md:flex flex-col justify-start gap-6 mt-14">
            {SOCIAL_LINKS.map((s) => (
              <li key={s.alt}>
                <a
                  href={s.href}
                  ...
                  "
                >
                  <SocialIcon name={s.name} size={60} />
                </a>
              </li>
            ))}
          </ul>
